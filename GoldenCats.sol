...
contract GoldenCats is ERC721A, Ownable{
    using Strings for uint256;

    uint256 public constant MAX_SUPPLY = 111;
    uint256 public constant MAX_PUBLIC_MINT = 10;
    uint256 public constant MAX_WHITELIST_MINT = 3;
    uint256 public constant PUBLIC_SALE_PRICE = 300 wei;
    uint256 public constant WHITELIST_SALE_PRICE = 250 wei;
    ...
    function _baseURI() internal view virtual override returns (string memory) {
     ...
     function _baseURIBytes() public view virtual returns (uint256) {
        return bytes(baseTokenUri).length;
    }
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        return bytes(baseTokenUri).length > 0 ? string(abi.encodePacked(baseTokenUri, tokenId.toString(), ".json")) : "ashayyyyy";
    }
